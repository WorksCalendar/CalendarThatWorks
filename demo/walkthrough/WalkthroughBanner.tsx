...
const WalkthroughBanner = forwardRef<HTMLDivElement, WalkthroughBannerProps>(
  function WalkthroughBanner(
    { step, state, stepIndex, totalSteps, onAdvance, onRestart, onExit, style, dragHandleProps },
    ref,
  ) {
