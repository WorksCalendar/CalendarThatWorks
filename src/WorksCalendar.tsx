/**
 * WorksCalendar Ã¢â‚¬â€ main component.
 */
import {
...
export type WorksCalendarProps = {
   ...
   *   - omitted (default) Ã¢â€ â€™ no chip row renders
   *   - `true`            Ã¢â€ â€™ renders the library's DEFAULT_FOCUS_CHIPS
   *   - `FocusChipDef[]`  Ã¢â€ â€™ renders that custom chip list
   ...
   * guided walkthrough before the calendar renders Ã¢â‚¬â€ with a prominent
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Assets view Ã¢â€â‚¬Ã¢â€â‚¬
...
const ALL_VIEWS: readonly ViewDef[] = [
  { id: 'month',    label: 'Month',    alwaysOn: true,  hint: 'Scheduled events Ã¢â‚¬â€ appointments, missions, PTO' },
  { id: 'week',     label: 'Week',     alwaysOn: true,  hint: 'Scheduled events by day Ã¢â‚¬â€ not staffing or on-call' },
  { id: 'day',      label: 'Day',      alwaysOn: false },
  { id: 'agenda',   label: 'Agenda',   alwaysOn: false },
  { id: 'schedule', label: 'Schedule', alwaysOn: false, hint: 'Staffing Ã¢â‚¬â€ day/night shifts, on-call rotation, duty status' },
  { id: 'base',     label: 'Base',     alwaysOn: false, hint: 'Gantt-style Ã¢â‚¬â€ employees, aircraft, and base events side by side' },
...
export const WorksCalendar = forwardRef<CalendarApi, WorksCalendarProps>(function WorksCalendar(
  {
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Owner Ã¢â€â‚¬Ã¢â€â‚¬
    ownerPassword           = '',
    onConfigSave,

    // Ã¢â€â‚¬Ã¢â€â‚¬ Dev mode Ã¢â‚¬â€ unlocks all admin features without a password Ã¢â€â‚¬Ã¢â€â‚¬
    devMode                 = false,
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Event callbacks Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Supabase realtime Ã¢â€â‚¬Ã¢â€â‚¬
    supabaseUrl,
    supabaseKey,
    supabaseTable,
    supabaseFilter,

    // Ã¢â€â‚¬Ã¢â€â‚¬ Access control Ã¢â€â‚¬Ã¢â€â‚¬
    role        = 'admin',   // 'admin' | 'user' | 'readonly'

    // Ã¢â€â‚¬Ã¢â€â‚¬ Employees (for schedule/timeline view) Ã¢â€â‚¬Ã¢â€â‚¬
    employees   = [],
    onEmployeeAdd,
    onEmployeeDelete,
    onEmployeeAction,
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Validation Ã¢â€â‚¬Ã¢â€â‚¬
    blockedWindows,

    // Ã¢â€â‚¬Ã¢â€â‚¬ Appearance Ã¢â€â‚¬Ã¢â€â‚¬
    theme       = 'light',
    colorRules,
    businessHours,

    // Ã¢â€â‚¬Ã¢â€â‚¬ Custom rendering Ã¢â€â‚¬Ã¢â€â‚¬
    renderEvent,
    renderHoverCard,
    renderToolbar,
    renderFilterBar,
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Filter schema (pass a custom FilterField[] to extend or replace defaults) Ã¢â€â‚¬Ã¢â€â‚¬
    filterSchema,

    // Ã¢â€â‚¬Ã¢â€â‚¬ UI toggles Ã¢â€â‚¬Ã¢â€â‚¬
    showAddButton           = false,
    showSetupLanding        = false,

    // Ã¢â€â‚¬Ã¢â€â‚¬ Initial view (overrides saved config on first render) Ã¢â€â‚¬Ã¢â€â‚¬
    initialView,

    // Ã¢â€â‚¬Ã¢â€â‚¬ Week start day (prop takes priority over owner config) Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ Resource pools (#212) Ã¢â€â‚¬Ã¢â€â‚¬
    pools: rawPools,
    onPoolsChange,
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ View / date / filter state Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // made from the Settings Ã¢â€ â€™ Employees tab (e.g. renaming a member) are
  ...
  // Explicit initialView prop takes precedence Ã¢â‚¬â€ hosts that opt into a
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Permissions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const perms = usePermissions(role);

  // Ã¢â€â‚¬Ã¢â€â‚¬ Admin-managed event options (categories) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const eventOptions = useEventOptions(calendarId);

  // Ã¢â€â‚¬Ã¢â€â‚¬ Saved view active state Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Setup landing gate Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Active groupBy / sort (controlled by props; overridden when a saved view is applied) Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ FilterGroupSidebar state Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Assets view: zoom level + collapse state + location provider Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Base/Region view: multi-base selection Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Visible date range (drives fetch + occurrence expansion) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const range = useMemo(
    () => viewRange(cal.view, cal.currentDate, weekStartDay),
    [cal.view, cal.currentDate, weekStartDay],
  );

  // Ã¢â€â‚¬Ã¢â€â‚¬ Async fetch Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const { fetchedEvents, loading: fetchLoading } = useFetchEvents(
    fetchEvents, cal.view, cal.currentDate, weekStartDay,
  );

  // Ã¢â€â‚¬Ã¢â€â‚¬ Source store (ICS feeds + CSV datasets, persisted per calendarId) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const sourceStore = useSourceStore(calendarId);

  // Ã¢â€â‚¬Ã¢â€â‚¬ Aggregator: merges prop feeds + stored ICS + stored CSV Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const { events: sourceEvents, feedErrors } = useSourceAggregator({
    icalFeedsProp: icalFeeds,
    sourceStore,
  });

  // Ã¢â€â‚¬Ã¢â€â‚¬ Supabase Realtime Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Merge all sources Ã¢â€ â€™ normalize Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const allNormalized = useMemo(() => {
    ...
    // included as-is Ã¢â‚¬â€ using title+start as a fallback key would silently
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ CalendarEngine Ã¢â‚¬â€ single source of truth for mutations & expansions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Expand recurring events within the visible range (via engine) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  // eslint-disable-next-line react-hooks/exhaustive-deps
  // Cast preserves the file's existing loose typing pattern Ã¢â‚¬â€ expandedEvents
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Base/Region view config Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const configuredBases = ownerCfg.config?.['team']?.bases ?? [];
  const locationLabel   = ownerCfg.config?.['team']?.locationLabel ?? 'Base';

  // Ã¢â€â‚¬Ã¢â€â‚¬ Visible-tabs config (Setup/ConfigPanel Ã¢â€ â€™ Views) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const VIEWS = useMemo(() => {
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Derive categories / resources / filtered events Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  // Events scoped to the active tab Ã¢â‚¬â€ drives BOTH FilterBar option lists and
  ...
  // Categories offered in the generic EventForm Ã¢â‚¬â€ hide schedule-workflow
  ...
  // Resolve asset-request category ids Ã¢â€ â€™ {id, label} pairs by looking up the
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Mutation pipeline (engine-authoritative) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  // Stable ref so applyEngineOp closure never goes stale.
  // Cast preserves the prior loose-typed assignment Ã¢â‚¬â€ the prop shapes for
  ...
  // { op, occurrenceDate, onAccepted, actionLabel } Ã¢â‚¬â€ set when a recurring event edit needs a scope choice
  ...
  const applyEngineOp = useCallback((op: LooseValue, onAccepted: LooseValue) => {
    ...
    if (result.status === 'accepted' || result.status === 'accepted-with-warnings') {
      // State has changed Ã¢â‚¬â€ record the pre-mutation snapshot.
      ...
      // Rejected Ã¢â‚¬â€ state unchanged, nothing to record.
      setPendingAlert({ violations: result.validation.violations, isHard: true, onConfirm: null });
    }
  }, [engine, undoManager]); // engine/undoManager are singleton refs Ã¢â‚¬â€ stable

  // Ã¢â€â‚¬Ã¢â€â‚¬ Local UI state Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // { event, x, y } Ã¢â‚¬â€ set when an event is clicked in edit mode
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Keyboard shortcuts Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  useEffect(() => {
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ CalendarApi / imperative handle Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  const api = useMemo(() => ({
  ...
  const handleCoverageAssign = useCallback((ev: LooseValue, coveringEmployeeId: LooseValue) => {
    ...
    //    coverage Ã¢â‚¬â€ not the entire underlying shift.
   ...
   * - 'pto' | 'unavailable' | 'availability' Ã¢â€ â€™ opens AvailabilityForm
   * - 'schedule' Ã¢â€ â€™ opens ScheduleEditorForm
  ...
  const handleEventSave = useCallback((rawEv: LooseValue) => {
    ...
    if (!eventId) {
      // New event Ã¢â‚¬â€ no scope picker needed.
      ...
      applyEngineOp(op, (result: LooseValue) => {
        ...
        // record up by the id the engine actually assigned Ã¢â‚¬â€ otherwise
    ...
    // Existing event Ã¢â‚¬â€ may be a recurring occurrence.
  ...
  const handleEditFromHoverCard = useCallback((ev: LooseValue) => {
    ...
    // Recurring occurrences carry rrule:null Ã¢â‚¬â€ look up the series master so the
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Context value Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬ Toolbar date label Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  function getDateLabel() {
    ...
    switch (cal.view) {
      ...
      case 'week': {
        ...
        if (sameMo)  return `${format(ws, 'MMM d')} Ã¢â‚¬â€œ ${format(we, 'd, yyyy')}`;
        if (sameYr)  return `${format(ws, 'MMM d')} Ã¢â‚¬â€œ ${format(we, 'MMM d, yyyy')}`;
        return `${format(ws, 'MMM d, yyyy')} Ã¢â‚¬â€œ ${format(we, 'MMM d, yyyy')}`;
      }
      default:
  ...
  const filterSummaryText = filterSummaryItems.length > 0
    ? (() => {
        ...
        if (labels.length <= 2) return labels.join(' Ã‚Â· ');
        return `${labels.slice(0, 2).join(' Ã‚Â· ')} +${labels.length - 2} more`;
      })()
    : 'All items';
  ...
  // Date-select (drag-to-create or day click) Ã¢â€ â€™ open form seeded with the range
  ...
  // Schedule cell select Ã¢â€ â€™ route to schedule-specific editor, not generic EventForm.
  ...
  // save Ã¢â‚¬â€ the generic form doesn't need a pool-picker field.
  ...
  return (
    <CalendarErrorBoundary>
      <CalendarContext.Provider value={ctxValue}>
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Profile / Saved-views Bar Ã¢â€â‚¬Ã¢â€â‚¬ */}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Filter Bar (legacy, kept for renderFilterBar override) Ã¢â€â‚¬Ã¢â€â‚¬ */}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ View area (with sidebar overlay) Ã¢â€â‚¬Ã¢â€â‚¬ */}
        <FilterGroupSidebar
          open={sidebarOpen}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ View area Ã¢â€â‚¬Ã¢â€â‚¬ */}
        <div
          ref={swipeAreaRef}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Hover card Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {selectedEvent && (
          renderHoverCard
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Event form Ã¢â€â‚¬Ã¢â€â‚¬ */}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Asset request form Ã¢â€â‚¬Ã¢â€â‚¬ */}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Availability / PTO form Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {availabilityState && (
          <AvailabilityForm
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Schedule editor form Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {scheduleEditorState && (
          <ScheduleEditorForm
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Import zone Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {importOpen && (
          <ImportZone onImport={handleImport} onClose={() => setImportOpen(false)} />
        )}

        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Schedule templates Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {scheduleOpen && (
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Recurring scope picker Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {recurringPrompt && (
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Validation alert Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {pendingAlert && (
          <ValidationAlert
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Owner config panel Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {ownerCfg.configOpen && (
          <ConfigPanel
            config={ownerCfg.config}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Keyboard shortcuts cheat sheet Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {helpOpen && <KeyboardHelpOverlay onClose={() => setHelpOpen(false)} />}

        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Screen reader live region Ã¢â€â‚¬Ã¢â€â‚¬ */}
        <ScreenReaderAnnouncer ref={announcerRef} />
        </div>

        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Inline event editor (edit mode) Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {inlineEditTarget && (
          <InlineEventEditor
